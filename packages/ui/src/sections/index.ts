export { Header, type HeaderProps, type NavItem, type NavColumn, type NavLink } from "./Header";
export { Footer, type FooterProps, type FooterLinkColumn, type FooterSocialLink } from "./Footer";
