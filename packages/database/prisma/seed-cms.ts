...
export async function seedCms(prisma: PrismaClient): Promise<void> {
  await prisma.contentBlock.upsert({
    ...
    create: {
      ...
      imageUrl: "https://placehold.co/1920x1400/e7e4de/111111?text=SILONYA",
  ...
  await prisma.contentBlock.upsert({
    ...
    create: {
      ...
      imageUrl: "https://placehold.co/1200x1500/e7e4de/111111?text=SILONYA+Journal",
  ...
  const pages: {
    ...
    },
    {
      ...
      heroImageUrl: "https://placehold.co/1600x900/e7e4de/111111?text=Atelier+Notebook",
    },
    {
      ...
      heroImageUrl: "https://placehold.co/1600x900/e7e4de/111111?text=Autumn+2026+Lookbook",
    },
  ];
